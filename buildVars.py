...
addon_info = {
	...
	"addon_name": "espeakExternal",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	"addon_summary": _("Espeak External"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("""espeak, externally!"""),
	# version
	"addon_version": "0.1",
	# Author(s)
	"addon_author": "Christopher Toth <q.alpha@gmail.com>",
	...
	# Add-on runtime environment, can be "internal" or "external"
	# "internal" means the add-on runs within NVDA's process space (default)
	# "external" means the add-on may run in a separate process (requires NVDA 2024.2 or later)
	"addon_runtime": "external",
}
...
pythonSources = ["addon/synthDrivers/**.*"]
